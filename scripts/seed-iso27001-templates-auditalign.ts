...
async function seedISO27001Templates() {
  try {
    console.log('Starting ISO 27001 templates seeding...');
    ...
    if (iso27001Framework.length === 0) {
      console.log('No ISO 27001 framework found. Creating one...');
...
*This template is part of the ISO 27001:2022 compliance framework implementation.*`
      ...
      console.log('ISO 27001 framework already exists. Adding templates to existing framework...');
...
*This template is part of the ISO 27001:2022 compliance framework implementation.*`
        ...
        console.log(`Framework already has ${existingControls.length} controls. Checking for missing templates...`);
        ...
        if (existingTemplates.length < ISO27001_TEMPLATES.length) {
          console.log('Some templates are missing. This needs manual review.');
        }
      }
    }
